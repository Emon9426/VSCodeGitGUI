...
const PATHS: Record<string, readonly string[]> = {
  ...
  // ---------- 视图/工具栏/操作图标（Issue #18 S4：去 emoji） ----------
  /** 拉取：下箭头 + 托盘 */
  pullDown: ['M8 3v7.6', 'M4.8 7.4 8 10.6l3.2-3.2', 'M2.6 12.6h10.8'],
  /** fetch：双向循环箭头（区别于 refresh 单弧箭头） */
  syncFetch: ['M12.9 5.9A5.2 5.2 0 0 0 3.2 4.4', 'M3.2 1.8v2.6h2.6', 'M3.1 10.1A5.2 5.2 0 0 0 12.8 11.6', 'M12.8 14.2v-2.6h-2.6'],
  /** 提交图视图：节点 + 连线 */
  graph: [
    'M1.9 8a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0 -3.2 0',
    'M6.4 4a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0 -3.2 0',
    'M6.4 12a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0 -3.2 0',
    'M10.9 8a1.6 1.6 0 1 0 3.2 0 1.6 1.6 0 1 0 -3.2 0',
    'M5 7.4 6.6 5.2', 'M5 8.6 6.6 10.8', 'M9.5 5.2 11 7.1', 'M9.5 10.8 11 8.9',
  ],
  /** 纯列表视图：三横线 */
  list: ['M2.4 4h11.2', 'M2.4 8h11.2', 'M2.4 12h11.2'],
  /** 工作副本视图：分栏面板 */
  panel: ['M2.2 2.8h11.6v10.4H2.2z', 'M7.4 2.8v10.4'],
  /** 文件历史视图：文件夹 + 表针 */
  folderClock: ['M1.6 13.6V2.8h4.4l1.6 2h6.8v8.8z', 'M8.7 7.2a2.3 2.3 0 1 0 .1 4.6 2.3 2.3 0 0 0-.1-4.6', 'M8.7 8.4v1.2l.9.6'],
  /** 设置：齿轮 */
  gear: [
    'M8 6.2a1.8 1.8 0 1 0 .1 3.6A1.8 1.8 0 0 0 8 6.2',
    'M8 1.8v1.8', 'M8 12.4v1.8', 'M1.8 8h1.8', 'M12.4 8h1.8',
    'M3.6 3.6l1.3 1.3', 'M11.1 11.1l1.3 1.3', 'M12.4 3.6l-1.3 1.3', 'M4.9 11.1l-1.3 1.3',
  ],
  /** 分支：上下节点 + 干线 + 右支 */
  branch: [
    'M2.6 3.4a1.4 1.4 0 1 0 2.8 0 1.4 1.4 0 1 0 -2.8 0',
    'M2.6 12.6a1.4 1.4 0 1 0 2.8 0 1.4 1.4 0 1 0 -2.8 0',
    'M10.6 5.4a1.4 1.4 0 1 0 2.8 0 1.4 1.4 0 1 0 -2.8 0',
    'M4 4.8v6.4', 'M4 8.6c0-2 1.4-3.2 3.6-3.2h1.8',
  ],
  /** 排队：沙漏 */
  hourglass: ['M3.6 2h8.8', 'M3.6 14h8.8', 'M4.8 2v2.6L8 8l3.2-3.4V2', 'M4.8 14v-2.6L8 8l3.2 3.4V14'],
  /** 编辑：铅笔 */
  pencil: ['M10.9 2.2l2.9 2.9L5.6 13.3l-3.8.9.9-3.8z'],
  /** 暂存/取消暂存 */
  plus: ['M8 3v10', 'M3 8h10'],
  minus: ['M3 8h10'],
  /** 主目录 */
  home: ['M2.4 7 8 2.4 13.6 7', 'M4 6.2v7.4h8V6.2', 'M6.8 13.6V9.8h2.4v3.8'],
  /** 最近提交：时钟 */
  clock: ['M1.8 8a6.2 6.2 0 1 0 12.4 0A6.2 6.2 0 0 0 1.8 8', 'M8 4.6V8l2.4 1.4'],
  /** AI 生成：四芒星 */
  sparkle: ['M8 1.8 9.6 6.4 14.2 8 9.6 9.6 8 14.2 6.4 9.6 1.8 8 6.4 6.4z'],
  /** 搜索 */
  search: ['M2.4 6.8a4.4 4.4 0 1 0 8.8 0 4.4 4.4 0 1 0 -8.8 0', 'M10.6 10.6 14 14'],
  /** 重命名/文档 */
